...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Sistema de ferias</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>" class="brand-link">
      <img src="<?php echo $URL;?>/public/images/7889361.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Sistema de ferias</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $URL;?>/ferias" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listado de ferias</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo $URL;?>/ferias/create.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Crear feria</p>
                </a>
              </li>
           ...
           <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $URL;?>/eventos" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listado de eventos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo $URL;?>/eventos/create.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Crear evento</p>
                </a>
              </li>
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $URL;?>/galeria" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
