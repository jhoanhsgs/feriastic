...
include('../app/controllers/ferias/listado_de_ferias.php');
?>
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">ferias registrados</h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($datos_ferias as $datos_feria) {
                                        $id_feria = $datos_feria['id_feria']
                                        ?>
                                        <tr>
                                            <td><center><?php echo $contador = $contador + 1; ?></center></td>
                                    <td><?php echo $datos_feria['nombre_feria']; ?></td>
                                    <td><?php echo $datos_feria['fecha_inicio']; ?></td>
                                    <td><?php echo $datos_feria['fecha_fin']; ?></td>
                                    <!-- <td><?php echo $datos_feria['descripcion']; ?></td> -->
                                    <td>
                                    <center>
                                        <div class="btn-group">
